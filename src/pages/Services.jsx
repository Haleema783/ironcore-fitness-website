    ...
    <div className="mt-8">
      <div className="bg-black min-h-screen py-12 text-white">
        <div className="container mx-auto px-4">
          {/* Title */}
          <h1 className="text-4xl text-center font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent mb-6">
            Our Gym Services
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-black border border-gray-800 rounded-2xl p-8 text-center transition-all duration-500 hover:scale-105 hover:border-blue-500 shadow-md hover:shadow-lg"
              >
                {/* Icon */}
                {service.icon}
